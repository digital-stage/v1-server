...
export type OvTrackPresetId = ObjectId;
...
export type RemoteProducerId = ObjectId;
export type SoundCardChannelId = ObjectId;
export type OvTrackId = ObjectId;
export type RemoteVideoProducerId = ObjectId;
export type RemoteAudioProducerId = ObjectId;
