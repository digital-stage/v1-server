...
import {DEBUG_PAYLOAD, REDIS_HOSTNAME, REDIS_PASSWORD, REDIS_PORT, USE_REDIS} from "../../src/env";
import {ServerGlobalEvents, ServerUserEvents} from "../../src/events";
import Auth from "../../src/auth/IAuthentication";
